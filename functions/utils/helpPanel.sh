helpPanel(){
	...
	echo -e "\t${turquoiseColour} ./fetch-images-NASA.sh${endColour}${orangeColour} -p${endColour} ${greenColour}"./new_path"${endColour} ${orangeColour}-g${endColour} ${greenColour}26${endColour}"
