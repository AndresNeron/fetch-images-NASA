helpPanel(){
    ...
    echo -e "\t${orangeColour}-x\t${endColour}${grayColour} Set background using an absolute full path to an image ${endColour}"
    ...
    echo -e "\t${turquoiseColour} ./fetch-images-NASA.sh${endColour}${orangeColour} -x${endColour} ${greenColour}/home/ainode/Sync/AirFlow/images/image.jpg${endColour}"
